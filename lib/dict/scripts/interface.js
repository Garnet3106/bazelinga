...
class Interface {
    ...
    copyToClipboard(text) {
        // displayをnoneに設定するとコピペが効かなくなるので注意
        // selectAllChildren()のためにNodeオブジェクトを生成する
        ...
        getSelection().selectAllChildren(clipboardText);
    ...
    jumpToDictPage(langName) {
        location.href = 'https://bazelinga.gant.work/' + langName + '/dict/search/';
    }
